...
resource "aws_lb" "example" {
  arn                                                          = "arn:aws:elasticloadbalancing:us-east-1:847760228496:loadbalancer/app/DASHV7-DEMO-QA/00914fc8e0ec3aa2"
  arn_suffix                                                   = "app/DASHV7-DEMO-QA/00914fc8e0ec3aa2"
  client_keep_alive                                            = 3600
  customer_owned_ipv4_pool                                     = null
  desync_mitigation_mode                                       = "defensive"
  dns_name                                                     = "DASHV7-DEMO-QA-76520444.us-east-1.elb.amazonaws.com"
  ...
  id                                                           = "arn:aws:elasticloadbalancing:us-east-1:847760228496:loadbalancer/app/DASHV7-DEMO-QA/00914fc8e0ec3aa2"
  idle_timeout                                                 = 60
  internal                                                     = false
...
resource "aws_lb_listener" "imported_listener" {
  arn                                                                   = "arn:aws:elasticloadbalancing:us-east-1:847760228496:listener/app/DASHV7-DEMO-QA/00914fc8e0ec3aa2/fae5aff458105e40"
  certificate_arn                                                       = "arn:aws:acm:us-east-1:847760228496:certificate/9ebd32e1-f270-494b-8fbe-6007374025f6"
  id                                                                    = "arn:aws:elasticloadbalancing:us-east-1:847760228496:listener/app/DASHV7-DEMO-QA/00914fc8e0ec3aa2/fae5aff458105e40"
  load_balancer_arn                                                     = "arn:aws:elasticloadbalancing:us-east-1:847760228496:loadbalancer/app/DASHV7-DEMO-QA/00914fc8e0ec3aa2"
  port                                                                  = 443
  protocol                                                              = "HTTPS"
  ...
  default_action {
    order            = 1
    target_group_arn = "arn:aws:elasticloadbalancing:us-east-1:847760228496:targetgroup/DASHv7-demo/47d9731014f4d5b5"
    type             = "forward"
    ...
    forward {
      ...
      target_group {
        arn    = "arn:aws:elasticloadbalancing:us-east-1:847760228496:targetgroup/DASHv7-demo/47d9731014f4d5b5"
        weight = 1
      }
    }
  }
...
resource "aws_lb_target_group" "imported_tg" {
  arn                               = "arn:aws:elasticloadbalancing:us-east-1:847760228496:targetgroup/DASHv7-demo/47d9731014f4d5b5"
  arn_suffix                        = "targetgroup/DASHv7-demo/47d9731014f4d5b5"
  deregistration_delay              = "300"
  id                                = "arn:aws:elasticloadbalancing:us-east-1:847760228496:targetgroup/DASHv7-demo/47d9731014f4d5b5"
  ip_address_type                   = "ipv4"
  load_balancer_arns                = [
    "arn:aws:elasticloadbalancing:us-east-1:847760228496:loadbalancer/app/DASHV7-DEMO-QA/00914fc8e0ec3aa2",
  ]
  ...
  health_check {
    ...
    interval            = 30
    matcher             = "200,301,302"
    path                = "/assets/dspace/images/favicons/favicon.svg"
    port                = "traffic-port"
    protocol            = "HTTP"
    timeout             = 5
