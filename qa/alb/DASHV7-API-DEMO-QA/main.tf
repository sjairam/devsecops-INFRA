# aws_lb.example:
resource "aws_lb" "DASHV7-API-DEMO-QA" {
  arn                                                          = "arn:aws:elasticloadbalancing:us-east-1:847760228496:loadbalancer/app/DASHV7-API-DEMO-QA/173845a46f9f7d9e"
  arn_suffix                                                   = "app/DASHV7-API-DEMO-QA/173845a46f9f7d9e"
  client_keep_alive                                            = 3600
  customer_owned_ipv4_pool                                     = null
  desync_mitigation_mode                                       = "defensive"
  dns_name                                                     = "DASHV7-API-DEMO-QA-199272126.us-east-1.elb.amazonaws.com"
  ...
  id                                                           = "arn:aws:elasticloadbalancing:us-east-1:847760228496:loadbalancer/app/DASHV7-API-DEMO-QA/173845a46f9f7d9e"
  idle_timeout                                                 = 60
  internal                                                     = false
  ip_address_type                                              = "ipv4"
  load_balancer_type                                           = "application"
  name                                                         = "DASHV7-API-DEMO-QA"
  name_prefix                                                  = null
  preserve_host_header                                         = false
  security_groups                                              = [
    "sg-063b8998c99eec363",
    "sg-06bbfdb84171eb687",
    "sg-9d46bfe1",
  ]
  subnets                                                      = [
...
resource "aws_lb_listener" "imported_listener" {
  arn                                                                   = "arn:aws:elasticloadbalancing:us-east-1:847760228496:listener/app/DASHV7-API-DEMO-QA/173845a46f9f7d9e/351dc7e8a7a7f3d8"
  certificate_arn                                                       = "arn:aws:acm:us-east-1:847760228496:certificate/72275856-e192-4124-88cf-f07b98f814e6"
  id                                                                    = "arn:aws:elasticloadbalancing:us-east-1:847760228496:listener/app/DASHV7-API-DEMO-QA/173845a46f9f7d9e/351dc7e8a7a7f3d8"
  load_balancer_arn                                                     = "arn:aws:elasticloadbalancing:us-east-1:847760228496:loadbalancer/app/DASHV7-API-DEMO-QA/173845a46f9f7d9e"
  port                                                                  = 443
  protocol                                                              = "HTTPS"
  ...
  default_action {
    order            = 0
    target_group_arn = "arn:aws:elasticloadbalancing:us-east-1:847760228496:targetgroup/DASHV7-API-DEMO-QA/358d9b46fa81b4d0"
    type             = "forward"
    ...
    forward {
      ...
      target_group {
        arn    = "arn:aws:elasticloadbalancing:us-east-1:847760228496:targetgroup/DASHV7-API-DEMO-QA/358d9b46fa81b4d0"
        weight = 1
      }
    }
  }
...
resource "aws_lb_target_group" "imported_tg" {
  arn                               = "arn:aws:elasticloadbalancing:us-east-1:847760228496:targetgroup/DASHV7-API-DEMO-QA/358d9b46fa81b4d0"
  arn_suffix                        = "targetgroup/DASHV7-API-DEMO-QA/358d9b46fa81b4d0"
  deregistration_delay              = "300"
  id                                = "arn:aws:elasticloadbalancing:us-east-1:847760228496:targetgroup/DASHV7-API-DEMO-QA/358d9b46fa81b4d0"
  ip_address_type                   = "ipv4"
  load_balancer_arns                = [
    "arn:aws:elasticloadbalancing:us-east-1:847760228496:loadbalancer/app/DASHV7-API-DEMO-QA/173845a46f9f7d9e",
  ]
