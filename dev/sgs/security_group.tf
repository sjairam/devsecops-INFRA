...
resource "aws_security_group" "tfer--alb_console_sg_dev_sg-0689fac91d4ff85bb" {
...
resource "aws_security_group" "tfer--alb_deployment_sg_dev_sg-08e36d64387d82bfb" {
  description = "Allow incoming traffic to ALB"
...
resource "aws_security_group" "tfer--alb_logging_dev_sg-0b8c57c74ca5f3f4e" {
  description = "Allow incoming traffic to ALB"
...
resource "aws_security_group" "tfer--allow_vpn_ingress_to_rke-476294_sg-01b6b093d84fea1ed" {
  ...
  ingress {
    cidr_blocks = ["10.138.0.0/24"]
    description = "SJ DNS workers test"
    from_port   = "6384"
    protocol    = "udp"
    self        = "false"
    to_port     = "6384"
  ...
  name = "allow_vpn_ingress_to_rke-476294"
...
resource "aws_security_group" "tfer--curiosity-dev_sg-02437a9fb78942520" {
  description = "Access to curiosity-dev site"
  ...
  ingress {
    cidr_blocks = ["10.138.21.0/24", "10.138.22.0/24", "10.138.23.0/24", "10.138.24.0/24"]
...
resource "aws_security_group" "tfer--dev_alb_sg_api_sg-0914a7a365ad4af33" {
  description = "Allow incoming traffic to ALB"
...
resource "aws_security_group" "tfer--dev_alb_sg_priv_sg-0ef73ca11bf96ccb2" {
  description = "Allow incoming traffic to ALB"
...
resource "aws_security_group" "tfer--dev_alb_sg_sg-02026aa76fded2371" {
  description = "Allow incoming traffic to ALB"
  ...
  ingress {
    cidr_blocks = ["0.0.0.0/0"]
    description = "Allow Port redirect"
    from_port   = "80"
    protocol    = "tcp"
    self        = "false"
    to_port     = "80"
...
resource "aws_security_group" "tfer--dev_alb_sg_srv_sg-03c13ccbbbc4db9c7" {
  description = "Allow incoming traffic to ALB"
...
resource "aws_security_group" "tfer--jobmonitor-0020-access_sg-0b937f7d8e5d0302b" {
  description = "allows special-purpose connections to the dev Job Monitor"
  ...
  ingress {
    ...
    description = "https access from drs-dev-dropbox"
    from_port   = "443"
    protocol    = "tcp"
    self        = "false"
    to_port     = "443"
